...
/**
 * A text field overlay that is used to edit a TextFigure. A FloatingTextField
 * requires a two step initialization: In a first step the overlay is created
 * and in a second step it can be positioned.
 *
