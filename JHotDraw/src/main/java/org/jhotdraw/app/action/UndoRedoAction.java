...
import static org.jhotdraw.app.action.UndoAction.ID;
/**
...
public class UndoRedoAction extends AbstractViewAction {
    ...
    public PropertyChangeListener setProp(PropertyChangeListener redoActionPropertyListener){
        return redoActionPropertyListener;
    }
    
    public UndoRedoAction(Application app) {
        super(app);
    }
